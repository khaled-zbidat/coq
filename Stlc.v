...
induction t; intros t'; split; intros H.
  ...
  - inversion H;subst.
    simpl. apply IHt1 in H2. apply IHt2 in H4. rewrite H2. rewrite H4. reflexivity.
  - simpl in H. 
    destruct (eqb_string x0 s0) eqn:E.
  ...
  - inversion H;subst.
    simpl. 
    apply IHt1 in H3. apply IHt2 in H5. apply IHt3 in H6. subst. reflexivity.
Qed.
...
econstructor. econstructor. econstructor.  constructor. 
  apply T_App with (Ty_Bool). constructor. constructor.
  apply T_App with (Ty_Bool). constructor. constructor. constructor. constructor.
Qed.
(** [] *)

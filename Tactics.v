...
(** **** Exercise: 3 stars, standard, optional (apply_exercise1) 
...
Proof.
  ...
  injection eq1 as H. rewrite <- H0. rewrite H. symmetry. injection H1 as A. rewrite A. reflexivity.
...
(** **** Exercise: 1 star, standard, optional (discriminate_ex3)  *)
...
(** **** Exercise: 3 stars, standard, optional (plus_n_n_injective) 
...
Proof.
  ...
  - destruct n.
    ...
    + intros H. injection H as A. simpl. apply  IHl' in A. apply A. 
Qed.
...
Proof.
  ...
  - intros. destruct h as [a b]. simpl in H.
    destruct (split l') as [a' b']. inversion H. simpl. apply f_equal.
...
(** **** Exercise: 3 stars, standard, optional (eqb_sym)  *)
...
Definition split_combine_statement : Prop :=
  (* ("[: Prop]" means that we are giving a name to a
   ...
   forall X Y (l1 : list X) (l2 : list Y), length l1 =
     length l2 -> split (combine l1 l2) = (l1, l2).
...
(** **** Exercise: 3 stars, advanced, optional (filter_exercise) 

...
(** **** Exercise: 2 stars, standard, optional (filter_even_gt7) 
...
(** **** Exercise: 3 stars, standard, optional (map_rev) 
...
(** **** Exercise: 1 star, advanced, optional (fold_types_different) 
...
Proof.
  intros x l. induction l as [|X l' h].
  - simpl. reflexivity.
...
Proof.
    intros a b. destruct p. simpl. reflexivity.
...
(** **** Exercise: 1 star, advanced, optional (church_succ)  *)
...
(** **** Exercise: 1 star, advanced, optional (church_plus)  *)
...
(** **** Exercise: 2 stars, advanced, optional (church_mult)  *)
...
(** **** Exercise: 2 stars, advanced, optional (church_exp)  *)

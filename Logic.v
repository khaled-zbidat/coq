...
(** **** Exercise: 2 stars, standard, optional (and_exercise)  *)
...
(** **** Exercise: 1 star, standard, optional (mult_eq_0)  *)
Lemma mult_eq_0 :
...
(** **** Exercise: 1 star, standard, optional (or_commut)  *)
...
(** **** Exercise: 2 stars, advanced, optional (double_neg_inf) 
...
Proof.
  ...
  intros P Q H1 H2 H3.
  apply H1 in H3. unfold not in H2.
  apply H2. apply H3.
...
(** **** Exercise: 1 star, advanced, optional (informal_not_PNP) 
...
Proof.
  intros X P H [x H1].
  unfold not in H1. apply H1. apply H.
Qed.
...
(** **** Exercise: 3 stars, standard, optional (In_map_iff)  *)
Theorem In_map_iff :
...
(** **** Exercise: 3 stars, standard, optional (evenb_double_conv)  *)
...
(** **** Exercise: 2 stars, standard, optional (logical_connectives) 
...
(** **** Exercise: 1 star, standard, optional (eqb_neq) 
...
(** **** Exercise: 3 stars, standard, optional (eqb_list) 
...
(** **** Exercise: 2 stars, standard, optional (All_forallb) 
...
Proof.
  ...
  apply H. right. intros H2.
  apply H. left. apply H2.
Qed.
(** [] *)
...
Proof.
  ...
  intros H1 X P H2.
  intros x.
  destruct (H1 (P x)) as [H3 | H4].
  - apply H3.
  - exfalso. apply H2. exists x. apply H4.
Qed.
(** [] *)

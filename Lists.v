...
Proof.
  intros l1 l2. induction l1 as [| n l1' h]. 
...
Proof.
  intros l1 l2 l3 l4. induction l1 as [| n l1' h].
...
Proof.
  intros l1 l2. induction l1 as [| n l1' h].
  simpl. reflexivity.
  destruct n as [| n']. simpl. rewrite -> h. reflexivity.
...
Proof.
  intros l1 l2 h.
  rewrite <- rev_involutive. rewrite <- h. simpl.  rewrite -> rev_involutive.
  reflexivity.
Qed.
(** [] *)
...
(* FILL IN HERE 
  zero and it's because the constructor has no base so we cant build
  an instance from this type.
*)

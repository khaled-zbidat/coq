...
unfold deterministic. intros x y1 y2 H1 H2. generalize dependent y2.
   (induction H1) ; intros y2 H2; inversion H2; subst; auto.
      inversion H3. inversion H4. inversion H1.
      apply IHstep in H4. rewrite H4. reflexivity.
      inversion H3. rewrite <- H in H1. inversion H1. inversion H1.
...
Lemma multistep_congr_2 : forall t1 t2 t2',
     ...
     P t1 t2 -->* P t1 t2'.
Proof.
intros t1 t2 t2' H Ht2. (induction Ht2) .
  constructor.
  eapply multi_step. apply ST_Plus2. assumption. eassumption. assumption.
Qed.
(** [] *)
...
(** **** Exercise: 3 stars, standard, optional (multistep__eval)  *)
...
Theorem step_deterministic_proof_needed :
  deterministic step.
Proof.
  intros x x' y' H1' H2'. generalize dependent y'. induction H1'; intros y' Hy';
    inversion Hy'; subst; try solve_by_inverts 2;auto.
  - apply IHH1' in H2; auto. rewrite H2. simpl. reflexivity.
  - apply IHH1' in H4; rewrite H4. auto.
  - apply IHH1' in H3;auto. rewrite H3. auto.
Qed.

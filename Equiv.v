...
Proof.
  intros b c H.
  split; intros H1.
  - apply while_true_nonterm in H1.
    + inversion H1. 
    + apply H.
  - apply while_true_nonterm in H1.
    + inversion H1.
...
Definition equiv_classes : list (list com)
  :=[ [prog_a; prog_d] ;[prog_b; prog_e];
    [prog_c; prog_h]; [prog_f; prog_g];
    [prog_i] ].
...
Proof.
  ...
  - (* while *)
    ...
    remember (fold_constants_bexp b) as b'. destruct b';
      try (apply CWhile_congruence; assumption). apply while_true. assumption.
...
Proof.
  ...
  intros. unfold not. intros Contra. unfold cequiv in Contra.
  assert (empty_st=[skip]=> empty_st). apply E_Skip.
   apply Contra in H.
  apply while_true_nonterm in H. inversion H. apply refl_bequiv.
Qed.
(** [] *)
...
(** **** Exercise: 4 stars, standard, optional (capprox) 
